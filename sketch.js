...
if(keyCode===87&&X!=1){setTimeout(()=>{if(player.index!=null){var bul = new Bullet(p[player.index-1][0].position.x,p[player.index-1][0].position.y,0,-vdb,d,player.index,1);if(buls[player.index-1]==undefined){buls[player.index-1]=[player.index-1,[["b0",bul]]];TPIB="b1"}else{Bulslet(player.index-1,bul)};}},500)}
  //S:
if(keyCode===83&&X!=1){setTimeout(()=>{if(player.index!=null){var bul = new Bullet(p[player.index-1][0].position.x,p[player.index-1][0].position.y,0,vdb,d,player.index,1);if(buls[player.index-1]==undefined){buls[player.index-1]=[player.index-1,[["b0",bul]]];TPIB="b1"}else{Bulslet(player.index-1,bul)}}},500)}
  //A:
if(keyCode===65&&X!=1){setTimeout(()=>{if(player.index!=null){var bul = new Bullet(p[player.index-1][0].position.x,p[player.index-1][0].position.y,-vdb,0,d,player.index,1);if(buls[player.index-1]==undefined){buls[player.index-1]=[player.index-1,[["b0",bul]]];TPIB="b1"}else{Bulslet(player.index-1,bul)}}},500)}
  //D:
if(keyCode===68&&X!=1){setTimeout(()=>{if(player.index!=null){var bul = new Bullet(p[player.index-1][0].position.x,p[player.index-1][0].position.y,vdb,0,d,player.index,1);if(buls[player.index-1]==undefined){buls[player.index-1]=[player.index-1,[["b0",bul]]];TPIB="b1"}else{Bulslet(player.index-1,bul)}}},500)}
...
if(keyCode===87&&X==1){setTimeout(()=>{if(player.index!=null){var bul = new Bullet(p[player.index-1][0].position.x,p[player.index-1][0].position.y,-vdb,-vdb,d,player.index,1);if(buls[player.index-1]==undefined){buls[player.index-1]=[player.index-1,[["b0",bul]]];TPIB="b1"}else{Bulslet(player.index-1,bul)}}},500)}
  //S:
if(keyCode===83&&X==1){setTimeout(()=>{if(player.index!=null){var bul = new Bullet(p[player.index-1][0].position.x,p[player.index-1][0].position.y,vdb,vdb,d,player.index,1);if(buls[player.index-1]==undefined){buls[player.index-1]=[player.index-1,[["b0",bul]]];TPIB="b1"}else{Bulslet(player.index-1,bul)}}},500)}
  //A:
if(keyCode===65&&X==1){setTimeout(()=>{if(player.index!=null){var bul = new Bullet(p[player.index-1][0].position.x,p[player.index-1][0].position.y,-vdb,vdb,d,player.index,1);if(buls[player.index-1]==undefined){buls[player.index-1]=[player.index-1,[["b0",bul]]];TPIB="b1"}else{Bulslet(player.index-1,bul)}}},500)}
  //D:
if(keyCode===68&&X==1){setTimeout(()=>{if(player.index!=null){var bul = new Bullet(p[player.index-1][0].position.x,p[player.index-1][0].position.y,vdb,-vdb,d,player.index,1);if(buls[player.index-1]==undefined){buls[player.index-1]=[player.index-1,[["b0",bul]]];TPIB="b1"}else{Bulslet(player.index-1,bul)}}},500)}
}}
